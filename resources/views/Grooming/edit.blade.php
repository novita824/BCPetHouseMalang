   ...
   <div class="main-panel">
    <div class="content-wrapper">
      <div class="page-header">
        <h3 class="right" class="page-title"> TAMBAH DATA GROOMING </h3>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="{{route('GroomingUpdate')}}" method="POST" class="php-email-form">
              @csrf
              <input type="hidden" name="id" value="{{ $grooming->idgrooming }}">
              <div class="row">
                <div class="form-group">
                  <label for="name">No</label>
                  <input type="text" value="{{ $grooming->nogrooming }}" class="form-control" name="nogrooming" id="subject" required>
                </div>
                <div class="form-group">
                  <label for="name">Pemilik</label>
                  <input type="text" value="{{ $grooming->pemilik }}"  class="form-control" name="pemilik" id="subject" required>
                </div>
                <div class="form-group col-md-6">
                  <label for="name">Tipe Grooming</label>
                  <input type="text" value="{{ $grooming->tipe }}" name="tipe" class="form-control" id="subject" required>
                </div>
                <div class="form-group col-md-6">
                  <label for="name">Penanggungjawab</label>
                  <input type="text" value="{{ $grooming->pj }}" class="form-control" name="pj" id="subject" required>
                </div>
              </div>
              <div class="form-group">
                <label for="name">Harga</label>
                <input type="text" value="{{ $grooming->harga }}" class="form-control" name="harga" id="subject" required>
              </div>
              <div class="form-group">
                <label for="name">Harga Pokok</label>
                <input type="text" value="{{ $grooming->hargapokok }}" class="form-control" name="hargapokok" id="subject" required>
              </div>
              <div class="form-group">
                <label for="name">Status</label>
                <input type="text" value="{{ $grooming->status }}" class="form-control" name="status" id="subject" required>
              </div>
