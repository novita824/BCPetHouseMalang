    ...
    <div class="main-panel">
      <div class="content-wrapper">
        <div class="page-header">
          <h3 class="right" class="page-title"> TAMBAH DATA PENITIPAN </h3>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="{{ route('Penitipan.store') }}" method="POST" class="php-email-form">
              @csrf
              <div class="row">
                <div class="form-group">
                  <label for="name">No</label>
                  <input type="text" class="form-control" name="nopenitipan" id="subject" required>
                </div>
                <div class="form-group">
              ...
              <div class="text-center"><button class="btn btn-gradient-primary btn-sm" type="submit">Kirim</button></div>
