...
<body>
  ...
  <main id="main">
    ...
    @endif
    <form action="{{ route('Produk.update',$pk->id) }}" method="POST">
        @csrf
        @method('PUT')
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Nama:</strong>
                    <input type="text" name="nama" value="{{ $pk->nama }}" class="form-control" placeholder="Nama">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Produk:</strong>
                    <input class="form-control" name="produk" placeholder="Produk" value="{{ $pk->produk }}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Total Produk:</strong>
                    <input type="text" name="totalproduk" value="{{ $pk->totalproduk }}" class="form-control" placeholder="TotalProduk">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Total Harga:</strong>
                    <input class="form-control" name="totalharga" placeholder="TotalHarga" value="{{ $pk->totalharga }}">
                </div>
            </div>
